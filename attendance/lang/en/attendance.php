...
$string['medicalrest'] = 'Medical rest';
$string['medicalrestauthor'] = 'Recorded by';
$string['medicalrestcreated'] = 'The medical rest has been saved.';
$string['medicalrestdescription'] = 'Description';
$string['medicalrestempty'] = 'No medical rests have been recorded for this activity yet.';
$string['medicalrestenddate'] = 'End date';
$string['medicalrestheading'] = 'Medical rest registry';
$string['medicalrestinvalidrange'] = 'The end date must be later than the start date.';
$string['medicalrestperiod'] = 'Medical rest period';
$string['medicalrestrecords'] = 'Recorded medical rests';
$string['medicalrestregistrationdate'] = 'Registration date';
$string['medicalreststartdate'] = 'Start date';
$string['medicalreststudent'] = 'Student';
$string['medicalreststudentsnotfound'] = 'No enrolled students are available to register medical rests.';
$string['savemedicalrest'] = 'Save medical rest';
